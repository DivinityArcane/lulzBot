...
namespace lulzbot.Extensions
{
    public partial class Core
    {
        ...
        public Core ()
        {
            ...
            Events.AddCommand("autojoin", new Command(this, "cmd_autojoin", "DivinityArcane", 100, "Manages the bots autojoined channels.", ext: info));
            Events.AddCommand("act", new Command(this, "cmd_act", "DivinityArcane", 75, "Makes the bot say the specified message to the specified channel.", ext: info));
            Events.AddCommand("admin", new Command(this, "cmd_admin", "DivinityArcane", 75, "Makes the bot send the specified admin command to the specified channel.", ext: info));
            Events.AddCommand("ban", new Command(this, "cmd_ban", "DivinityArcane", 75, "Bans the specified user in the specified channel.", ext: info));
            ...
            Events.AddCommand("cycle", new Command(this, "cmd_cycle", "DivinityArcane", 75, "Makes the bot part and join a channel.", ext: info));
            Events.AddCommand("command", new Command(this, "cmd_command", "DivinityArcane", 100, "Disables certain commands.", ext: info));
            Events.AddCommand("commands", new Command(this, "cmd_commands", "DivinityArcane", 25, "Displays commands available to the user.", ext: info));
            Events.AddCommand("ctrig", new Command(this, "cmd_ctrig", "DivinityArcane", 100, "Changes the bot's trigger.", ext: info));
            Events.AddCommand("debug", new Command(this, "cmd_debug", "DivinityArcane", 100, "Toggles debug mode.", ext: info));
            ...
            Events.AddCommand("help", new Command(this, "cmd_help", "DivinityArcane", 25, "Checks the description of the specified command.", ext: info));
            Events.AddCommand("join", new Command(this, "cmd_join", "DivinityArcane", 75, "Makes the bot join the specified channel.", ext: info));
            Events.AddCommand("kick", new Command(this, "cmd_kick", "DivinityArcane", 75, "Makes the bot kick the specified person in the specified channel.", ext: info));
            Events.AddCommand("kill", new Command(this, "cmd_kill", "DivinityArcane", 75, "Makes the bot kill the specified person.", ext: info));
            Events.AddCommand("netusage", new Command(this, "cmd_netinfo", "DivinityArcane", 25, "Gets information on the network usage of the bot.", ext: info));
            Events.AddCommand("netinfo", new Command(this, "cmd_netinfo", "DivinityArcane", 25, "Gets information on the network usage of the bot.", ext: info));
            Events.AddCommand("npsay", new Command(this, "cmd_npsay", "DivinityArcane", 75, "Makes the bot say the specified message to the specified channel.", ext: info));
            Events.AddCommand("part", new Command(this, "cmd_part", "DivinityArcane", 75, "Makes the bot leave the specified channel.", ext: info));
            ...
            Events.AddCommand("promote", new Command(this, "cmd_promote", "DivinityArcane", 75, "Promotes the specified user in the specified channel.", ext: info));
            ...
            Events.AddCommand("say", new Command(this, "cmd_say", "DivinityArcane", 75, "Makes the bot say the specified message to the specified channel.", ext: info));
            Events.AddCommand("set", new Command(this, "cmd_set", "DivinityArcane", 75, "Sets the specified data for the specified channel.", ext: info));
            Events.AddCommand("sudo", new Command(this, "cmd_sudo", "DivinityArcane", 100, "Runs a command as the specified user.", ext: info));
            Events.AddCommand("system", new Command(this, "cmd_system", "DivinityArcane", 25, "Gets information on the host machine.", ext: info));
            Events.AddCommand("unban", new Command(this, "cmd_unban", "DivinityArcane", 75, "Un-bans the specified user in the specified channel.", ext: info));
            ...
            Events.AddCommand("whois", new Command(this, "cmd_whois", "DivinityArcane", 25, "Performs a whois on the specified user.", ext: info));
